...
#include "TriangleExtended.slang"
...
NOVA_EXAMPLE(TriangleBuffered, "tri-ext")
{
    ...
    auto vertex_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::Vertex, "VertexShader", "TriangleExtended.slang");
    NOVA_DEFER(&) { vertex_shader.Destroy(); };

    auto fragment_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::Fragment, "FragmentShader", "TriangleExtended.slang");
