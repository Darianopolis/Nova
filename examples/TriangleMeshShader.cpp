...
NOVA_EXAMPLE(TriangleMeshShader, "tri-mesh")
{
    ...
    auto task_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::Task, "Task", "TriangleMeshShader.slang");
    NOVA_DEFER(&) { task_shader.Destroy(); };
    auto mesh_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::Mesh, "Mesh", "TriangleMeshShader.slang");
    NOVA_DEFER(&) { mesh_shader.Destroy(); };
    auto fragment_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::Fragment, "Fragment", "TriangleMeshShader.slang");
