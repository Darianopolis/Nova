...
NOVA_EXAMPLE(RayTracing, "rt")
{
    ...
    auto ray_gen_shader = nova::Shader::Create(context,     nova::ShaderLang::Slang, nova::ShaderStage::RayGen,     "RayGeneration", "RayTracing.slang");
    NOVA_DEFER(&) { ray_gen_shader.Destroy(); };
    auto miss_shader = nova::Shader::Create(context,        nova::ShaderLang::Slang, nova::ShaderStage::Miss,       "Miss",          "RayTracing.slang");
    NOVA_DEFER(&) { miss_shader.Destroy(); };
    auto closest_hit_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::ClosestHit, "ClosestHit",    "RayTracing.slang");
