...
#include "TriangleRayTrace.slang"
...
// -----------------------------------------------------------------------------
    ...
    auto closest_hit_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::ClosestHit, "ClosestHit", "TriangleRayTrace.slang");
    NOVA_DEFER(&) { closest_hit_shader.Destroy(); };

    auto ray_gen_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::RayGen, "RayGeneration", "TriangleRayTrace.slang");
    NOVA_DEFER(&) { ray_gen_shader.Destroy(); };

    auto ray_query_shader = nova::Shader::Create(context, nova::ShaderLang::Slang, nova::ShaderStage::Compute, "Compute", "TriangleRayTrace.slang");
