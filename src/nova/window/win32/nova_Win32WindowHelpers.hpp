...
static
std::string Win32_WindowMessageToString(UINT msg)
{
    switch (msg)
    {
        break;case WM_SETCURSOR: return "";
        break;case WM_NCHITTEST: return "";
        break;case WM_NCMOUSEMOVE: return "";
    ...
    return std::format("MSG({0} - {0:#x})", msg);
}